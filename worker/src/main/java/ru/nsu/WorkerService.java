...
public class WorkerService {
    private final int taskTimeout = 300;
    ...
    public void ReceiveTask(CrackHashManagerRequest part) {
        ...
        for (int i = 0; i <= part.getMaxLength(); i++) {
            ...
            var generatorPermutations = Generator
            ...
            while(generatorPermutations.hasNext()) {
                String str = String.join("", generatorPermutations.next());
